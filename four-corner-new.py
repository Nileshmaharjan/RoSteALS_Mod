...
def correct_distortion(image_path, save_path):
    ...
    orb = cv2.ORB_create(nfeatures=5000)  # Increase the number of keypoints
...
correct_distortion('C:/Users/User/Documents/Projects/Nilesh/RoSteALS/examples/4_capture.png', 'C:/Users/User/Documents/Projects/Nilesh/RoSteALS/examples/4_capture_c.png')
